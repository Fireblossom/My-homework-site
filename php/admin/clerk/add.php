        ...
        <div class="row">
        	<div class="col-xs-3">
                <div class="list-group">
                    ...
                    <a href="#" class="list-group-item active">业务员管理</a>
        	...
        	<div class="col-xs-9">
                <form class="form-horizontal" role="form" method='post' action='checkadd.php'>
                    <div class="form-group">
                        <label for="inputID" class="col-sm-2 control-label">业务员编号</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input name="collage" type="text" class="form-control" id="inputCollage" placeholder="顾客姓名">
                        </div>
                    </div>
                    <div class="form-group">
