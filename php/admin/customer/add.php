        	...
        	<div class="col-xs-9">
                <form class="form-horizontal" role="form" method='post' action='checkadd.php'>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input name="id" type="text" class="form-control" id="inputID" placeholder="账号">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputName" class="col-sm-2 control-label">顾客姓名</label>
                        <div class="col-sm-10">
                            <input name="name" type="text" class="form-control" id="inputName" placeholder="顾客姓名">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputGollage" class="col-sm-2 control-label">部门</label>
                        <div class="col-sm-10">
                            <input name="collage" type="text" class="form-control" id="inputGollage" placeholder="部门">
                        </div>
                    </div>
                    <div class="form-group">
