...
$sql = "select datab_clerk.name as teacher_name,
datab_subject.id as id,datab_subject.name as name,
datab_subject.collage as collage from datab_clerk inner join datab_subject on datab_clerk.id=datab_subject.teacher";

//$sql = "select * from datab_clerk order by id asc";
